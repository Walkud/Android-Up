package com.walkud.self.module.pagergrid;
...
import com.walkud.self.view.pagergrid.MyPageIndicator;
import com.walkud.self.view.pagergrid.PageGridView;
...
public class GridPagerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gridpager);
    ...
    public class MyAdapter extends PageGridView.PagingAdapter<MyVH> implements PageGridView.OnItemClickListener {
        ...
        public MyVH onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(GridPagerActivity.this).inflate(R.layout.layout_item, parent, false);
        ...
        public void onItemClick(PageGridView pageGridView, int position) {
            ...
            Toast.makeText(GridPagerActivity.this, gridview + " 第" + (position + 1) + "个item 被点击" + " 值：" + mData.get(position), Toast.LENGTH_SHORT).show();
        }
    }
