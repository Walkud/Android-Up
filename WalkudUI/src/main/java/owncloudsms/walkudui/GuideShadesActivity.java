...
//    FrameLayout rootLayout;
    ...
    public void initData() {
        ...
        indicatorViewPager = new ShadesIndicatorViewPager(scrollIndicatorView, viewPager);
    ...
    public void addListener() {
        indicatorViewPager.setOnPageChangeListener(new ShadesIndicatorViewPager.OnPageChangeListenerAdapter() {
