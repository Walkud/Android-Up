package owncloudsms.walkudui.view.scroll;
 ...
 */
public class LinearLayoutManagerPlus extends LinearLayoutManager {
    ...
    public LinearLayoutManagerPlus(Context context, int orientation) {
